...
var drawingTabs = [{ //Main setup
	...
	{ //Tree
		...
		active: function (ctx) {
			...
			if (dynamicData.skillTree.hoveredNode && dynamicData.skillTree.hoveredNode !== "lock") {
				if (dynamicData.skillTree.nodes[dynamicData.skillTree.hoveredNode].showColor) {
