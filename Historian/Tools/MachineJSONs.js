var simplifiedMachineData = {
	machineEarth: {
		...
		recipes: {
			...
			earthConversion1: {
				...
				out: [["Earth", 2, 5.2, 4, ["Earth", 10, "GolemEarth", 1]]],
				lock: ["Fire", 1],
			...
			earthRift3: {
				...
				in: [["Earth", 1, 1]],
				out: [["Earth", 1, 12000, 4, ["Alkahest", 0.002]]],
	...
	machineWater: {
		...
		recipes: {
			...
			waterRift1: {
				baseStats: [1, 0.1, false, false],
				in: [],
				out: [["Water", 1, 12, 10, ["Water", 80]]],
				upgrade: ["waterRift2", "Ice", 0.1, "Steam", 0.1],
			},
			waterRift2: {
				baseStats: [1, 1, false, false],
				in: [],
				out: [["Water", 10, 1200, 9, ["GolemWater", 5]]],
			},
			waterConversion1: {
				baseStats: [1, 1.02, true, true],
				in: [
				...
				out: [["Water", 2, 5.2, 4, ["Water", 10, "GolemWater", 1]]],
				lock: ["Air", 0.1],
			...
			waterRift3: {
				baseStats: [1, 1.4, false, true],
				in: [["Water", 1, 1]],
				out: [["Water", 1, 12000, 4, ["Alkahest", 0.002]]],
	...
	machineAir: {
		...
		recipes: {
			...
			airRift1: {
				baseStats: [1, 0.1, false, false],
				in: [],
				out: [["Air", 1, 12, 10, ["Air", 80]]],
				upgrade: ["airRift2", "Steam", 0.1, "Sand", 0.1],
			},
			airRift2: {
				baseStats: [1, 1, false, false],
				in: [],
				out: [["Air", 10, 1200, 9, ["GolemAir", 5]]],
			},
			airConversion1: {
				baseStats: [1, 1.02, true, true],
				in: [
				...
				out: [["Air", 2, 5.2, 4, ["Air", 10, "GolemAir", 1]]],
				lock: ["Fire", 1],
			...
			airRift3: {
				baseStats: [1, 1.4, false, true],
				in: [["Air", 1, 1]],
				out: [["Air", 1, 12000, 4, ["Alkahest", 0.002]]],
	...
	machineFire: {
		...
		recipes: {
			...
			fireRift1: {
				baseStats: [1, 0.1, false, false],
				in: [],
				out: [["Fire", 1, 12, 10, ["Fire", 75]]],
				upgrade: ["fireRift2", "Steam", 0.1, "Magma", 0.1],
			},
			fireRift2: {
				baseStats: [1, 1, false, false],
				in: [],
				out: [["Fire", 10, 1200, 9, ["GolemFire", 5]]],
			},
			fireConversion1: {
				...
				out: [["Fire", 2, 5.2, 4, ["Fire", 10, "GolemFire", 1]]],
				lock: ["Fire", 1],
			...
			fireRift3: {
				baseStats: [1, 1.4, false, true],
				in: [["Fire", 1, 1]],
				out: [["Fire", 1, 12000, 4, ["Alkahest", 0.002]]],
	...
	golemInfuser: {
		baseStats: [
			-195,
			195,
			["GolemEarth", "GolemWater", "GolemAir", "GolemFire"],
		],
		recipes: {
			golemEarth1: {
	...
	golemMerger: {
		...
		recipes: {
			...
			mergeSteam2: {
				...
				out: [["Steam", 1, 4.8, 3, ["GolemWater", 13]]],
			...
			mergeMagma2: {
				...
				out: [["Magma", 1, 4.8, 3, ["GolemEarth", 13]]],
	...
	machineMud: {
		...
		recipes: {
			...
			mudConversion2: {
				...
				out: [["Mud", 1, 52, 4, ["Mud", 60, "Glass", 0.8]]],
	...
	machineIce: {
		...
		recipes: {
			...
			iceConversion2: {
				...
				out: [["Ice", 1, 52, 4, ["Ice", 60, "Glass", 0.8]]],
				upgrade: [
					"iceConversion3",
					"Silicon",
					1,
	...
	machineSteam: {
		...
		recipes: {
			...
			steamConversion2: {
				...
				out: [["Steam", 1, 52, 4, ["Steam", 60, "Glass", 0.8]]],
	...
	machineMagma: {
		...
		recipes: {
			...
			magmaConversion2: {
				...
				out: [["Magma", 1, 52, 4, ["Magma", 60, "Glass", 0.8]]],
	...
	machineSand: {
		...
		recipes: {
			...
			sandConversion2: {
				...
				out: [["Sand", 1, 52, 4, ["Magma", 180, "Soil", 1.6]]],
			...
			voidClash3: {
				...
				out: [
					...
					[
						...
						-150,
						2,
						["Mud", 200, "Mud", 400, "Mud", 800, "Mud", 1600, "Mud", 2500],
					],
				],
			},
			voidConversion3: {
	...
	machines: {
		machineKnowledge: {
			...
			recipes: {
				...
				revelationGain1: {
					baseStats: [1, 0.1, true, true],
					in: [["Gold", 1, 0.3]],
					out: [["Revelation", 1, 1.2, 4, ["Knowledge", 8]]],
					lock: ["Gold", 0.1],
		...
		machineSnow: {
			...
			recipes: {
				snowMerge1: {
					...
					out: [["Snow", 1, 1.2, 4, ["Cryospire", 0.1, "Vortex", 0.1]]],
					lock: ["Knowledge", 0.3],
				},
			},
		},
		...
		machineGlass: {
			...
			recipes: {
				glassMerge1: {
					...
					out: [["Glass", 1, 1.2, 2, ["Knowledge", 36]]],
		...
		machineDistill: {
			baseStats: [
				-400,
				500,
				["DistilledEarth", "DistilledWater", "DistilledAir", "DistilledFire"],
			],
			recipes: {
				distillEarth1: {
					baseStats: [1, 0.1, true, true],
...
var lifeCircle = {
	...
	machines: {
		...
		machinePlantEarth: {
			...
			recipes: {
				...
				harvestEarth1: {
					baseStats: [1, 1, true, true],
					in: [["PlantEarth", 100, 10]],
					out: [["EssenceEarth", 1, 7, 7, ["FoldedSpace", 0.01]]],
					lock: ["PlantEarth", 1],
				},
				uprootEarth2: {
		...
		machinePlantWater: {
			...
			recipes: {
				...
				harvestWater1: {
					baseStats: [1, 1, true, true],
					in: [["PlantWater", 100, 10]],
					out: [["EssenceWater", 1, 7, 7, ["Force", 1]]],
					lock: ["PlantWater", 1],
				},
				uprootWater2: {
	...
	preprocess: function () {
			...
			for (var rec in this.machines[mach].reciconv) {
				for (var j = 0; j < this.baseElements.length; j++) {
					var recipe = JSON.parse(
						JSON.stringify(this.machines[mach].reciconv[rec])
					);
		...
		this.machines["machineSeedElements"].recipes["seedWater"].lock.push(
			"Cryospire"
		);
		...
		this.machines["machineSeedElements"].recipes["seedFire"].in.push([
			"Blast",
			0,
			0.3,
		]);
		this.machines["machineUnPureSoilElements"].recipes[
			"infuseSoilFire"
		].out[0][1] = 1250;
		for (var mach in this.machines) {
		...
		machineFoldedSpatial: {
			...
			recipes: {
				foldedSpatialCreation1: {
					baseStats: [1, 0.1, true, true],
					in: [["FoldedSpace", 1, 0.1]],
					out: [["FoldedSpatial", 1, 1.2]],
					lock: ["FoldedSpace", 1],
				},
				foldedSpatialProduce1: {
					baseStats: [1, 0.1, true, true],
					in: [["FoldedSpatial", 1, 0.1]],
					out: [
		...
		machineFoldedTemporal: {
			...
			recipes: {
				foldedTemporalCreation1: {
					baseStats: [1, 0.01, true, true],
					in: [["FoldedSpace", 3, 1.1]],
					out: [["FoldedTemporal", 1, 1.2]],
		...
		machineTime: {
			...
			recipes: {
				...
				timeBend1: {
					...
					in: [["Time", 3, 0.01]],
					out: [],
					lock: ["FoldedTemporal", 1, "Time", 1e6],
				},
			},
		},
	},
...
var gemCircle = {
		...
		machineAdvancedCompress: {
			...
			recipes: {
				...
				ashCompress2: {
					...
					out: [["CompressedAsh", 5, 1.2]],
				},
				dustCompress1: {
					baseStats: [1, 0.01, true, true],
					in: [["Dust", 100, 11]],
					out: [["CompressedDust", 1, 0.1]],
					lock: ["Dust", 11],
		...
		machineStone: {
			...
			recipes: {
				gravelProduction1: {
					...
					out: [["Gravel", 1, 1.2, 10, ["PureEarth", 1]]],
					lock: ["Energy", 1],
				},
				pebbleProduction1: {
				...
				pebbleProduction2: {
					...
					out: [["Pebbles", 1, 1.2, 10, ["FoldedSpace", 200]]],
					lock: ["Energy", 1],
				},
				stoneProduction1: {
					baseStats: [1, 0.8, true, true],
	...
	decay: function () {
		for (
			var i = 0;
			i < machineData.machineRandomGem.recipes[0].outputs.length;
			i++
		) {
