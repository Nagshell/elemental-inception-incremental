var lore = {
	"loreMessages": {
		...
		"catalyst1": {
			"text": "Yes, it works! Sadly it seems that new Catalyst structure is much weaker.\n" +
		...
		"stash0": {
			"text": "Losing all my Elements each time I create a Golem is slowing my progress a lot.\n" +
		...
		"merge0": {
			"text": "Elemental wave created by Golem pulled another one to it and darkness surrounded them.\n" +
		...
		"eat0": {
			"text": "It seems that two Golems of the same type can't coexists together inside small space.\n" +
		...
		"infernal0": {
			"text": "Golem, which I decided to name 'Infernal' feels special.\n" +
		...
		"infernal1": {
			"text": "My suspicion was right. As soon as I crossed 1e90 threshold Infernal Golem reversed\n" +
		...
		"ending0": {
			"text": "Once Infernal reached it maximal size it rose into the air from pedestal and\n" +
	...
	"popupMessages": {
		"catalyst0": {
			"text": "Elemental wave caused by my curse focused on Catalyst.\n" +
				"And soon after shattered it into pieces.",
			//"changeTab" : 0
		},
		"merge0": {
			"text": "Another Orb imploded into Golem and wave reached another Golem.\n\n" +
	...
	"bannerMessages": {
		...
		"pun6": {
			"text": "Did you notice puns are getting incrementally more funny each time you hear them?" +
				"                                                                                           " +
	...
	"addLore": function (loreId) {
		dynamicData.lore.obtained.push(loreId);
