	...
	loreTree:
	{
		Logbook:
		{
			...
			"Summer, 363":
			{
				"7th Day":
				{
					text: "I’ve embedded multiple storage pipes into a wall, each filled with one of the Elements. In case of danger, they’ll make a chain reaction and clear the entire area out of every bit of Elements. | | I’ve also started preparing Fire lanterns for sale. Next on the shopping list: More machine parts and maybe some weapons for self-defense."
				},
				"20th Day":
				{
				...
				"21st Day":
				{
					text: "I’m ready to recreate Golems. The last time I tried making a few of the same type, it resulted in a complete waste of resources, but now I have a good plan on how to hold them still. I’ll open small rift between pedestals and it should jam the attractive force between Golems. I’ve devised a special chamber that doesn’t isolate but redirect Elemental waves into the ground. Finally, their creation won’t waste my resources as much. | | Next goal is automating the process of moving and merging golems."
				},
				"23rd Day":
				{
					text: "I let my first pair of Golem merge today, but the resulting Mud Golem collapsed immediately. I can only suspect that it’s the Alchemist doing after the Infernal incident. But it took a couple of seconds to disappear completely, so maybe I could try reaching into the broken Golem with my Glove and pull out whatever is inside. | | Yes! It was a huge success. Not only did I manage to pull in a bit of Mud Element, but I also understand the nature of Golems much better. Simply put, it’s like just my rifts, a connection to the source of Element, but it is an incredibly complicated object. I don’t think I could replicate it in any other way than imploding a compression crystal inside the orb. | | Now… I’m not sure why something like a Mud Element even exists. Elementalism was supposed to use only 4 Elements. Yes, it was hard getting it, but I think books on the subject would mention the existence of other types… Something about this definitely feels sketchy."
				},
				"36th Day":
				{
					text: "After going to town to sell some of my lanterns, I was able to buy many more machine parts. With the rest of the money, I bought some explosives and a simple rifle. I’ll need to practice shooting in my free time, after all, the last time I was shooting anything like that was during my years studying under my master. | | Now it’s time to set everything up for new machines. Let’s see how far can we go with new Elements I discovered. Sadly I wasn’t able to extract Inferno out of Infernal Golem. For some unknown reason, when I pulled from it, nothing happened. I’ll need to investigate it later. At the moment though, I’ll start gathering more of the advanced Element I can extract out of Golems, and design some conversions based on similarities between them."
				},
				"44th Day":
				{
				...
				"46th Day":
				{
					text: "I’m going to the city for a couple of days. I’ll leave machines running while I’m gone. Assimilation process is taking its sweet time, I hope it’ll be done by the time I’m back."
				},
				"Encounter":
				{
					text: "When I came back I saw a womanly figure crouching next to Aggregator and staring intensely inside it. Immediately, I quietly stepped back, put down the box that I was carrying and readied my rifle. I came back into the room, aiming at her, and yelled:\“Who are you and what are you doing here\!\?\” | | Her name is Opal. Thankfully, she was quite peaceful, and after quite a long talk she simply left. Huh, I guess I really grew weary of people. Anyway, I learned quite a bit about the Alchemist from her. Apparently, he studied Elementalism, and he got so deep into the research that it changed him permanently. Now he has a split personality, and if he doesn’t focus, his behavior changes based on the Elements channeling through him. And, of course, he tries to stop everybody from pursuing knowledge in this subject. That’s why the whole art is in recession. | | Before leaving, Opal told me that she will be back with some of her friends in a few weeks and that they will help me against the Alchemist. It sounded like they created some sort of a guerilla opposing him. I decided that we will meet in a remote location and then I’ll decide if we can agree to work together."
				},
				"Aftermath":
				{
					text: "Was I bit too trusting? Well, at least she didn’t try to kill me on a spot, and she seemed really interested in my research. I couldn’t help but notice that she was looking at me with nearly the same intensity as she was looking at my machines before. | | But how did she find this place? It’s not that entrance was masked perfectly, it literally wasn’t there! I’m sealing it off with a good amount of ground and rocks, and when I came back it looked exactly as I left it. I think I’ll make some small safes in a few places around the city to hide some money and supplies, in case something happens to my base. At least I won’t be starting from nothing again."
				},
			},
			"Summer, 363.":
			{
		...
		Records:
		{
			...
			"Opal":
			{
				...
				"Underground":
				{
					text: "As Opal descended she found out what caused anomaly, multiple pipes filled to brim with Elements and carved with patterns she never saw before. That’s exciting, just like everybody in her team, the person who created those has a completely new way of controlling Elements. She had to get inside the structure though, and pipes were quite densely packed. Opal couldn’t sense any gaps through the pipe barrier, but she found a spot where there wasn’t solid rock behind the barrier. She made a small gap there, just enough to fit a finger through it, and used her uniquely developed skill. Attuning herself to Air, she ‘blinked’ through that gap. She spent a bit of time fixing hole she dug up and then she started exploring the structure. | | The structure was huge, yet mostly empty, there was a large central room with a few smaller rooms around it. In the smaller rooms, she only found a couple of tables littered with tiny metal pieces. In the main room, she found decently sized contraption in the middle. And it made her jaw drop to the floor.",
				},
				"Findings":
				{
